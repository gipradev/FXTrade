...
import com.example.fxcaptrade.RecyclerAdaptor.TeamReturnListAdaptor;
 ...
 */
public class TeamReturnsFragment extends Fragment {
    private static final String TAG = "TeamReturnsFragment";
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ((AppCompatActivity)getActivity()).getSupportActionBar().setSubtitle("Team Returns");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_team_returns, container, false);
    }
    ...
    private void getTeamReturnList(final String userID) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                WebServices.BaseUrl + "Referal_roi", new Response.Listener<String>() {
            @Override
    ...
    private void generateData(JSONArray array) {
        ...
        teamReturn = new TeamReturnListAdaptor(getContext(), array);
    ...
    private void declarations(View view) {
        activityView = view;
        requestQueue = Volley.newRequestQueue(getContext());
        listRecycler = (RecyclerView) view.findViewById(R.id.teamReturnList);
        progressBar = (ProgressBar) view.findViewById(R.id.progressReturns);
