...
import com.example.fxcaptrade.RecyclerAdaptor.ActiveListAdaptor;
 ...
 */
public class ActiveFragment extends Fragment implements ActiveListAdaptor.OnActiveListListener{
    ...
    private ActiveListAdaptor activityList;
    ...
    private void getActiveList(final String userID) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                WebServices.BaseUrl + "Active_referal_list", new Response.Listener<String>() {
            @Override
    ...
    private void generateData(JSONArray array) {
            ...
            activityList = new ActiveListAdaptor(getContext(), array,this);
    ...
    private void declarations(View view) {
        activityView = view;
        requestQueue = Volley.newRequestQueue(getContext());
        listRecycler = (RecyclerView) view.findViewById(R.id.activeMembers);
        progressBar = (ProgressBar) view.findViewById(R.id.progressActive);
    ...
    @Override
    public void onMoreClick(String active_user_id) {

        ViewMoreInvestments moreInvestments = new ViewMoreInvestments(getContext(),active_user_id);
        moreInvestments.show(getActivity().getSupportFragmentManager(), moreInvestments.getTag());
