...
import com.example.fxcaptrade.RecyclerAdaptor.InvestmentReturnAdaptor;
...
public class ReturnFragment extends Fragment {
    ...
    private InvestmentReturnAdaptor recyclerTrans;
    ...
    private void getTransactions() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                WebServices.BaseUrl + "Investment_return_report", new Response.Listener<String>() {
            @Override
...
//                        Toast.makeText(getActivity(), "No Data", Toast.LENGTH_SHORT).show();
    ...
    private void generateData(JSONArray array) {
        ...
        recyclerTrans = new InvestmentReturnAdaptor(getContext(), array);
    ...
    private void loadMore(final String user_id) {
        progressBar.setVisibility(View.VISIBLE);
        if (requestQueue == null) {
            requestQueue = Volley.newRequestQueue(getActivity());
            Log.e(TAG, "Setting a new request queue");
