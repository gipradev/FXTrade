...
import com.example.fxcaptrade.RecyclerAdaptor.TeamRewardListAdaptor;
 ...
 */
public class TeamRewardsFragment extends Fragment {
    private static final String TAG = "TeamRewardsFragment";
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        ((AppCompatActivity)getActivity()).getSupportActionBar().setSubtitle("Team Rewards");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_team_rewards, container, false);
    }
    ...
    private void getTeamRewardList(final String userID) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                WebServices.BaseUrl + "Rewards_wallet_details/", new Response.Listener<String>() {
            @Override
    ...
    private void generateData(JSONArray array) {
        ...
        teamReturn = new TeamRewardListAdaptor(getContext(), array);
        linearLayoutManager = new LinearLayoutManager(getContext());
        linearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        listRecycler.setHasFixedSize(true);
        listRecycler.setLayoutManager(linearLayoutManager);
        listRecycler.setAdapter(teamReturn);
            ...
            public void run() {
                ...
                for(int i = 0 ; i < dataArray.length() ; i++){
                    try {
                        ...
                        teamReturn.notifyDataSetChanged();
    ...
    private void declarations(View view) {
        ...
        activityView = view;
        requestQueue = Volley.newRequestQueue(getContext());
        listRecycler = (RecyclerView) view.findViewById(R.id.teamRewards);
        progressBar = (ProgressBar) view.findViewById(R.id.progressTeamRewards);
