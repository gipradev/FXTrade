...
import com.example.fxcaptrade.RecyclerAdaptor.InvestmentListAdaptor;
...
public class InvestmentDetails extends Fragment {
    private static final String TAG = "InvestmentDetails";
    ...
    private InvestmentListAdaptor recyclerTrans;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_investment_details, container, false);
    ...
    private void getTransactions() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                WebServices.BaseUrl + "Investment_details", new Response.Listener<String>() {
            @Override
    ...
    private void generateData(JSONArray array) {
        ...
        recyclerTrans = new InvestmentListAdaptor(getContext(), array);
    ...
    private void declaration(View view) {
        ...
        progressBar = (ProgressBar) view.findViewById(R.id.progressInvestDetails);
