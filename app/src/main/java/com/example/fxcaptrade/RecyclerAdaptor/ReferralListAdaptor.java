...
public class ReferralListAdaptor extends RecyclerView.Adapter<ReferralListAdaptor.MyViewHolder> {

    private final Context context;
    private final JSONArray jsonArray;

    public ReferralListAdaptor(Context applicationContext, JSONArray array) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.referral_item,null);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        try {
            ...
            holder.amount.setText("$ "+object.getString("invest_amount"));
