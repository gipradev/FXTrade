 ...
 */
public class IncomeWallet extends Fragment {
    private static final String TAG = "IncomeWallet";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_income_wallet, container, false);
    }
    @Override
    ...
    private void getDetails() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                WebServices.BaseUrl + "Income_wallet_details", new Response.Listener<String>() {
            @Override
