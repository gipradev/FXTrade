 ...
 */
public class InvestmentWallet extends Fragment {
    private static final String TAG = "InvestmentWallet";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_investment_wallet, container, false);
    }
  ...
  //***********************************************************************************************************
    ...
    private void getDetails() {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST,
                    WebServices.BaseUrl + "Investment_wallet_details", new Response.Listener<String>() {
                @Override
