 ...
 */
public class RewardWallet extends Fragment {

    private static final String TAG = "RewardWallet";
    ...
    private RewardListAdaptor recyclerTrans;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_reward_wallet, container, false);
    }
    ...
    private void generateData(JSONArray array) {
        ...
        recyclerTrans = new RewardListAdaptor(getContext(), array);
