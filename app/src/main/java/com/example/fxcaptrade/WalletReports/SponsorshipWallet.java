 ...
 */
public class SponsorshipWallet extends Fragment {
    private static final String TAG = "SponsorshipWallet";
    ...
    private WalletListAdaptor recyclerTrans;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sponsorship_wallet, container, false);
    }
    ...
    private void getDetails() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                WebServices.BaseUrl + "Reference_wallet_details", new Response.Listener<String>() {
            @Override
    ...
    private void generateData(JSONArray array) {
        ...
        recyclerTrans = new WalletListAdaptor(getContext(), array);
